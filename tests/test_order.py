...
class TestOrders:
    ...
    def test_order_with_auth(self, created_user):
        res_reg, _ = created_user
        token = res_reg.json()["accessToken"]
    ...
    def test_order_no_ing_fail(self, created_user):
        res_reg, _ = created_user
        res = BurgerApiClient.create_order({"ingredients": []}, res_reg.json()["accessToken"])
    ...
    def test_order_bad_hash_fail(self, created_user):
        res_reg, _ = created_user
        res = BurgerApiClient.create_order({"ingredients": ["not_a_hash"]}, res_reg.json()["accessToken"])
